...
// =========================================================================
{
  ...
  // Dé 61 : le repli ne se dérobe pas ; la défense (Esquive 0) ne sauve pas non plus → 10 dégâts.
  const s2 = clonerEtat(etat);
  const e2 = resoudreRepli(s2, "H1", { q: 0, r: -3 }, desFixe([61, 99]), plateau);
  verifier("dé 61 : l'attaque d'opportunité porte (10 dégâts)", s2.combattants.H1.pv === 50,
  ...
  verifier("avec 0 % de chance, même un dé de 1 ne sauve pas", s3.combattants.H1.pv === 50);
